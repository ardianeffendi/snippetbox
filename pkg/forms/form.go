...
// Define a New function to initialise a custom Form struct.
...
// Implement a MaxLength method to check taht a specific field in the form
...
// Implement a MinLenght method to check that a specific field in the form
// contains a minimum number of characters. If the checks fails then add the
// appropriate message to the form errors.
...
// Implement a MathesPattern method to check that a specific field in the form
