...
func TestPing(t *testing.T) {
	// Initialise a new httptest.ResponseRecorder
	rr := httptest.NewRecorder()

	// Initialise a new dummy http.Request
	...
	// http.ResponseRecorder and http.Request
	ping(rr, r)

	// Call the Result() method on hte http.ResponseRecorder to get the
